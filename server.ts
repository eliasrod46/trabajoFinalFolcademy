...
app.get("/", (req, res) => {
  res.send(`
                ...
                <h4>En este desafio implementamos una conexion a mongoDB con mongoose y establecimos tre endpoints get(trate todos los usuarios), post(agrega un usaurio) y delete(elimina un usuario indicando su username)</h4>
